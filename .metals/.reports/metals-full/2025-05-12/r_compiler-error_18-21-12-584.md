file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/common/record/MemoryRecordsBuilder.java
...
action parameters:
offset: 2915
uri: file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/common/record/MemoryRecordsBuilder.java
text:
```scala
/*
...
public class MemoryRecordsBuilder implements AutoCloseable {
    ...
    // the written bytes. Byt@@eBufferOutputStream allocates a new ByteBuffer if the existing one is not large enough,
