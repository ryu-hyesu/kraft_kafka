...
action parameters:
offset: 6080
uri: file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/clients/consumer/internals/FetchCollector.java
text:
```scala
/*
        ...
        try {
            while (recordsRemaining > 0) {
                ...
                if (nextInLineFetch == null || nextInLineFetch.isConsumed()) {
                    ...
                    // when the partition is paused w@@e add the records back to the completedFetches queue instead of draining
