file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/common/compress/Compression.java
...
action parameters:
offset: 2650
uri: file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/common/compress/Compression.java
text:
```scala
/*
...
public interface Compression {
     ...
     * performance impact.
     */
    InputStream wrapForInput(ByteBuffer buffer, by@@te messageVersion, BufferSupplier decompressionBufferSupplier);
