...
import org.apache.kafka.common.record.Compression;

import org.apache.kafka.common.record.TimestampType;
 import org.apache.kafka.comm@@on.serialization.Deserializer;
 ...
 public class SharedMemoryConsumer {
    ...
    public static void writeSharedMemoryByBuffer(
     ...
     public static MemoryRecords readSharedMemoryAsMemoryRecords() {
        ...
        // ✅ 여기 수정
        ByteBuffer bufferOut = ByteBuffer.allocate(512);
