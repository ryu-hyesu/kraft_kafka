file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/common/record/CompressionType.java
...
action parameters:
offset: 1264
uri: file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/common/record/CompressionType.java
text:
```scala
/*
...
public enum CompressionType {
    ...
    GZIP((byte) 1, "gzip", 1.0f) {
        public static final int MIN_LEVEL = Defla@@ter.BEST_SPEED;
