file://<WORKSPACE>/clients/build/generated/main/java/org/apache/kafka/common/message/FetchResponseData.java
...
action parameters:
offset: 38802
uri: file://<WORKSPACE>/clients/build/generated/main/java/org/apache/kafka/common/message/FetchResponseData.java
text:
```scala
/*
...
public class FetchResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_17 = SCHEMA_16;
    ...
    public static class PartitionData implements Message {
        ...
        public static final Schema SCHEMA_11 =
            new Schema(
                ...
                new Field("log_start_offset", Type.INT64, "The current log start offset."),
                new Field("aborted_transactions", ArrayOf.nullable(AbortedTransaction.SCHEMA_4), "The aborted transactions."),
                new Field("preferred_read@@_replica", Type.INT32, "The preferred read replica for the consumer to use on its next fetch request."),
                new Field("records", Type.RECORDS, "The record data.")
            );
        ...
        public static final Schema SCHEMA_12 =
            new Schema(
                ...
                TaggedFieldsSection.of(
                    ...
                    1, new Field("current_leader", LeaderIdAndEpoch.SCHEMA_12, "The current leader of the partition."),
        ...
        public final void read(Readable _readable, short _version) {
            ...
            }
            {
                ...
                if (length < 0) {
                    throw new RuntimeException("non-nullable field records was serialized as null");
                } else {
    ...
    public static class EpochEndOffset implements Message {
        ...
        public static final Schema SCHEMA_12 =
            new Schema(
                new Field("epoch", Type.INT32, "The largest epoch."),
