file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/clients/consumer/StickyAssignor.java
...
action parameters:
offset: 857
uri: file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/clients/consumer/StickyAssignor.java
text:
```scala
/*
...
import org.apa@@che.kafka.clients.consumer.internals.AbstractStickyAssignor;
