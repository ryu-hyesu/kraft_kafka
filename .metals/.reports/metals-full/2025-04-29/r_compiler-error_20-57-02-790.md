file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/clients/consumer/internals/ConsumerInterceptors.java
...
action parameters:
offset: 3842
uri: file://<WORKSPACE>/clients/src/main/java/org/apache/kafka/clients/consumer/internals/ConsumerInterceptors.java
text:
```scala
/*
...
public class ConsumerInterceptors<K, V> implements Closeable {
     ...
     * <p>
     * This method does not throw exceptions. Exceptio@@ns thrown by any of the interceptors in the chain are logged, but not propagated.
     *
